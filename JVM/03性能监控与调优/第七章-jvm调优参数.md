...
```bash
## 运行java、java-help 提示内容
```

![image-20210715143543513](第六章-jvm调优参数.assets/image-20210715143543513.png)
...
>   *   -Xint   ： 禁用JIT，所有字节码都被解释器执行
>   *   -Xcomp  ： 所有字节码均由后端解释器即jit编译成本地代码后执行
>   *   -Xmixed  ： 混合模式，即初次编译由解释器解释执行，当达到热点代码后由jit执行
>   *   -Xms<size>        设置初始 Java 堆大小
>   *   -Xmx<size>        设置最大 Java 堆大小
>   *   -Xss<size>        设置 Java 线程堆栈大小
...
*   非Boolean 类型格式（key-value类型）
    ...
    *   非数值型格式
        ...
        ```bash
        -XX:HeapDumpPath=/usr/local/heap.hprof
        ```
...
*   idea
    ...
    ![image-20210715145427915](第六章-jvm调优参数.assets/image-20210715145427915.png)
...
*   通过Tomcat运行war包
    ...
    *   win下修改catalina.bat
    ...
    >   set "JAVA_OPTS=-Xms50m -Xmx50m -XX:PrintGCDetails"
...
![image-20210715150922698](第六章-jvm调优参数.assets/image-20210715150922698.png)
...
![image-20210715151034577](第六章-jvm调优参数.assets/image-20210715151034577.png)
